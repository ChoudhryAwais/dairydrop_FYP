                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 items-center">
                  ...
                  <div className="md:hidden w-full pt-3 flex items-center justify-end gap-2">
                    ...
                    {!(order.status && order.status.toLowerCase() === 'cancelled') && (
                      <button
                        onClick={(e) => { e.stopPropagation(); if (typeof onBuyAgain === 'function') onBuyAgain(order); }}
                        className="px-3 py-1.5 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg text-sm font-semibold hover:from-green-700 hover:to-green-800 transition-all"
                      >
                        Buy Again
                      </button>
                    )}
                    ...
                    <div className="flex flex-col items-end gap-2">
                      ...
                      {order.status === 'Delivered' && (
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            if (typeof onBuyAgain === 'function') onBuyAgain(order);
                          }}
                          className="px-3 py-2 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg text-sm font-semibold hover:from-green-700 hover:to-green-800 transition-all shadow-sm"
                        >
                          Buy Again
                        </button>
                      )}
                    ...
                    View Invoice
                      ...
                      {!(order.status && order.status.toLowerCase() === 'cancelled') && (
                        <button
                          ...
                          className="flex-1 px-4 py-2 md:py-3 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-semibold rounded-lg md:rounded-xl transition-all shadow-md hover:shadow-lg text-sm md:text-base"
                        >
                          Buy Again
                        </button>
                      )}
